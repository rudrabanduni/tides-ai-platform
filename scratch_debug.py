...
from tests.test_explanation_engine import DummyDocument, DummyProfile, DummyClaim, DummyEvidence, DummyObservation, DummyRisk, DummyQuestion, DummyAssessment
from app.modules.explainability import ExplanationEngine

# Reconstruct sample graph logic
...
print("Assessments in graph:", list(graph.assessments.keys()))
print("Observations in graph:", list(graph.observations.keys()))
print("Out edges:", list(graph.out_edges.keys()))

engine = ExplanationEngine()
exp = engine.explain_committee_decision(graph, "dec-1")

print("Target ID:", exp.target_id)
print("Target Type:", exp.target_type)
print("Lineage Assessments:", [a["node_id"] for a in exp.lineage.assessments])
print("Lineage Observations:", [o["node_id"] for o in exp.lineage.observations])
print("Lineage Claims:", [c["node_id"] for c in exp.lineage.claims])
print("Lineage Evidence:", [e["node_id"] for e in exp.lineage.evidence])
print("Lineage Documents:", [d["node_id"] for d in exp.lineage.documents])
print("Metadata:", exp.metadata)
